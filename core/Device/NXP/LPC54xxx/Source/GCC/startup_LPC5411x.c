...
void WDT_BOD_IRQHandler (void) ALIAS(Default_IRQHandler);
...
void FLEXCOMM0_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM1_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM2_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM3_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM4_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM5_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM6_IRQHandler (void) ALIAS(Default_IRQHandler);
void FLEXCOMM7_IRQHandler (void) ALIAS(Default_IRQHandler);
...
void DMIC_IRQHandler (void) ALIAS(Default_IRQHandler);
void HWVAD_IRQHandler (void) ALIAS(Default_IRQHandler);
void USB_NEEDCLK_IRQHandler (void) ALIAS(Default_IRQHandler);
...
void Reset_Handler (void)
{
    asm volatile (
        ...
        ".set       SYSCON_CPUCTRL, 0x40000800\t\n"
        ".set       SYSCON_CPUCTRL_MASTERCPU_Msk, 0x00000001\t\n"
        ".set       SYSCON_CPBOOT, 0x40000804\t\n"
        ".set       SYSCON_CPSTACK, 0x40000808\t\n"
